...
class ServiceAvailabilityController extends Controller
{
    ...
    public function index(
        ...
        if (!$user->hasRole('service_provider')) {
            return response()->json([
                'message' =>
                    'Only service provider accounts can access service availability.',
            ], 403);
        }
    ...
    public function store(
        ...
        if (!$user->hasRole('service_provider')) {
            return response()->json([
                'message' =>
                    'Only service provider accounts can create service availability.',
            ], 403);
        }
        ...
        if (!$provider->is_active) {
            return response()->json([
                'message' =>
                    'Your provider account is inactive and cannot manage availability.',
            ], 403);
        }
        ...
        if ($provider->verification_status !== 'verified') {
            return response()->json([
                'message' =>
                    'Your business must be verified before you can manage availability.',
            ], 403);
        }
        ...
        if ($duplicateExists) {
            return response()->json([
                'message' =>
                    'An availability record already exists for this service, date and time range.',
            ], 409);
        }
        ...
        if (
            ...
            if ($overlapExists) {
                return response()->json([
                    'message' =>
                        'This availability time overlaps with an existing availability record.',
                ], 422);
            }
        }
        ...
        if (
            ...
            if ($dateAlreadyHasAvailability) {
                return response()->json([
                    'message' =>
                        'This date already contains availability records. Remove them before creating a full-day availability record.',
                ], 422);
            }
        }
        ...
        if (
            ...
            if ($fullDayRecordExists) {
                return response()->json([
                    'message' =>
                        'This date already has a full-day availability record.',
                ], 422);
            }
        }
    ...
    public function update(
        ...
        if (!$user->hasRole('service_provider')) {
            return response()->json([
                'message' =>
                    'Only service provider accounts can update service availability.',
            ], 403);
        }
        ...
        if (!$availability) {
            return response()->json([
                'message' =>
                    'Service availability record not found.',
            ], 404);
        }
        ...
        if (
            ...
            if ($dateAlreadyHasAvailability) {
                return response()->json([
                    'message' =>
                        'This date already contains other availability records.',
                ], 422);
            }
        }
    ...
    public function destroy(
        ...
        if (!$user->hasRole('service_provider')) {
            return response()->json([
                'message' =>
                    'Only service provider accounts can delete service availability.',
            ], 403);
        }
